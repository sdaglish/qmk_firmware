...
[_BASE] = LAYOUT( \
		 ...
		 KC_LBRC, KC_RBRC,                             KC_ESC,  RS_BSPC,  LGUI_TAB,               KC_LGUI, LW_SPC,  ALT_ENT, KC_MINS,KC_EQL \
		  ),
/* Raise
 * ,----------------------------------,                             ,----------------------------------,
 * |      |      |  mup |      |      |                             | VOL+ |      |  up  |      | PgUp |
...
[_RAISE] = LAYOUT( \
		  ...
		  KC_LBRC, KC_RBRC,                             KC_ESC,  RS_BSPC,  KC_LGUI,              KC_LGUI, LW_SPC,  ALT_ENT, KC_MINS,KC_EQL \
		   ),
...
[_LOWER] = LAYOUT( \
		  ...
		  KC_F11, KC_F12,                             KC_ESC,  RS_BSPC,  RESET,               KC_LGUI, LW_SPC,  ALT_ENT, KC_MINS,KC_EQL \
		   )
