 ...
 */
[_RAISE] = LAYOUT( \
		  KC_LALT, KC_QUOT,  KC_COMM,   KC_DOT, KC_P,   KC_Y,                                                   KC__VOLDOWN,   KC__VOLUP,   KC_C,   KC_R,   KC_L,  KC_LALT, \
...
[_LOWER] = LAYOUT( \
		  ...
		  KC_F11, KC_F12,                             CTL_ESC,  KC_DEL,  RESET,               KC_LGUI, LW_SPC,  ALT_ENT, S(KC_MINS),KC_EQL \
		   )
